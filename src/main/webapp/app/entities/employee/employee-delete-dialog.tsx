...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.employee.delete.question">
        <Translate contentKey="productionPlanFilteringApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
