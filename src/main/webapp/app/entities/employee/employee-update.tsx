  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanFilteringApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="productionPlanFilteringApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <UncontrolledTooltip target="firstNameLabel">
                  <Translate contentKey="productionPlanFilteringApp.employee.help.firstName" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="emailLabel" for="employee-email">
                  <Translate contentKey="productionPlanFilteringApp.employee.email">Email</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="productionPlanFilteringApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="productionPlanFilteringApp.employee.manager">Manager</Translate>
                </Label>
