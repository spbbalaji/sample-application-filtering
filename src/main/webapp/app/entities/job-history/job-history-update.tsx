  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanFilteringApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="productionPlanFilteringApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('productionPlanFilteringApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('productionPlanFilteringApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('productionPlanFilteringApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="productionPlanFilteringApp.jobHistory.job">Job</Translate>
                </Label>
