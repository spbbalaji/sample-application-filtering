...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.jobHistory.delete.question">
        <Translate contentKey="productionPlanFilteringApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
