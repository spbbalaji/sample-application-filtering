...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.department.delete.question">
        <Translate contentKey="productionPlanFilteringApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
