...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.location.delete.question">
        <Translate contentKey="productionPlanFilteringApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
