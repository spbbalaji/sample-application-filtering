...
export const RegionDeleteDialog = (props: IRegionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.region.delete.question">
        <Translate contentKey="productionPlanFilteringApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
