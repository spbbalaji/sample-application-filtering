...
export const JobDeleteDialog = (props: IJobDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.job.delete.question">
        <Translate contentKey="productionPlanFilteringApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
