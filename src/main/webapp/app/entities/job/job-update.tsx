  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="productionPlanFilteringApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="productionPlanFilteringApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="jobTitleLabel" for="job-jobTitle">
                  <Translate contentKey="productionPlanFilteringApp.job.jobTitle">Job Title</Translate>
                </Label>
                <AvField id="job-jobTitle" data-cy="jobTitle" type="text" name="jobTitle" />
              </AvGroup>
              <AvGroup>
                <Label id="minSalaryLabel" for="job-minSalary">
                  <Translate contentKey="productionPlanFilteringApp.job.minSalary">Min Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="maxSalaryLabel" for="job-maxSalary">
                  <Translate contentKey="productionPlanFilteringApp.job.maxSalary">Max Salary</Translate>
                </Label>
                <AvField id="job-maxSalary" data-cy="maxSalary" type="string" className="form-control" name="maxSalary" />
              </AvGroup>
              <AvGroup>
                <Label for="job-task">
                  <Translate contentKey="productionPlanFilteringApp.job.task">Task</Translate>
                </Label>
                <AvInput
                  id="job-task"
                  data-cy="task"
              ...
              <AvGroup>
                <Label for="job-employee">
                  <Translate contentKey="productionPlanFilteringApp.job.employee">Employee</Translate>
                </Label>
