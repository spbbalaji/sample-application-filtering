...
export const TaskDeleteDialog = (props: ITaskDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.task.delete.question">
        <Translate contentKey="productionPlanFilteringApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
