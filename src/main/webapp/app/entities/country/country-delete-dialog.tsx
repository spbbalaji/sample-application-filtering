...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productionPlanFilteringApp.country.delete.question">
        <Translate contentKey="productionPlanFilteringApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
